...
% [image, descriptors, locs] = sift(imageFile,resize_scale)
...
function [image, descriptors, locs] = sift(imageFile,varargin)

% Load image
image = imread(imageFile);
if nargin == 2
    image = imresize(image,varargin{1});
end
...
if isunix
    command = '!siftDemoV4/sift ';
else
    command = '!siftDemoV4\siftWin32 ';
end
